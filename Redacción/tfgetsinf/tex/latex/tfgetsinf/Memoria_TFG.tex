...
%Esto puede ir mucho mejor en otro sitio
...
%Cadena de markov, conjunto de estados, acciones, probabilidades, 
...
%%% AQUI HAY QUE PONER MUCHA MATEMÁTICA Y EXTENDERSE COMO UN CABRÓN
% https://joshgreaves.com/reinforcement-learning/understanding-rl-the-bellman-equations/
%%% SACARLA DE AQUI SI ESO


\subsection{Cadenas de Markov}

%Esto es una mierda de explicacion
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.2]{rlexample}
...
%% Falta mucha mierda aun por meter aqui
