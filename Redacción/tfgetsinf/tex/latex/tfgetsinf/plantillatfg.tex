...
Por último, se plantea realizar una implementación de un entorno simulador de un cubo de Rubik de distintos tamaños, y la posterior aplicación de las técnicas estudiadas al entorno creado.
